...
import 'package:hedieaty/utils/Barcode/scanned_barcode_label.dart';
import 'package:hedieaty/utils/Barcode/scanner_error_widget.dart';
      ...
      builder: (context, value, child) {
        ...
        return StreamBuilder<BarcodeCapture>(
          ...
          builder: (context, snapshot) {
            ...
            // Assuming you want to pop the screen once a barcode is scanned.
            // You can extract the barcode value if needed, e.g., scannedBarcode.displayValue

              Navigator.pop(context, scannedBarcode.displayValue); // Pass the barcode value back if needed
